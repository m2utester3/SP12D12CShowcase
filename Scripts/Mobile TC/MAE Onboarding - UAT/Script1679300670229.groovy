...
Mobile.startApplication('/users/APK/MAE.apk', false)

Mobile.takeScreenshot()

not_run: Mobile.tap(findTestObject('Object Repository/New Folder/android.widget.Button - Allow'), 0)

not_run: Mobile.takeScreenshot()

not_run: Mobile.tap(findTestObject('Object Repository/New Folder/android.widget.Button - While using the app'), 0)

not_run: Mobile.tap(findTestObject('Object Repository/New Folder/android.widget.Button - While using the app (1)'), 0)
